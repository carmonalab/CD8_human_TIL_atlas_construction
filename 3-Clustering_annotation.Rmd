...
marker.list <- ProjecTILs::FindAllMarkers.bygroup(integrated, split.by = "SampleLabel",
                                 ...
                                 min.diff.pct=0.1, min.freq = 2/3, verbose = F)
...
h <- celltype.heatmap(integrated, cluster.col = 'functional.cluster',  metadata=c("SampleLabel", "Tissue"),
                  assay = "RNA_trimmed", genes = genes.use.bygroup.trimm, min.cells=30, ref=integrated, cluster_genes = T, cluster_samples = TRUE, method="average", scale = "none", brewer.palette = "Blues", breaks = seq(0, RNA_log_cutoff, by = 0.1))

h

ggsave("plots/CD8T_heatmap_pseudobulk_clustered_average.pdf", plot=h, height=4, width=5)
ggsave("plots/CD8T_heatmap_pseudobulk_clustered_average_big.pdf", plot=h, height=7, width=9)


h <- celltype.heatmap(integrated, cluster.col = 'functional.cluster',  metadata=c("SampleLabel", "Tissue"),
                  assay = "RNA_trimmed", genes = genes.use.bygroup.trimm, min.cells=30, ref=integrated, cluster_genes = T, cluster_samples = TRUE, method="ward.D2", scale = "none", brewer.palette = "Blues", breaks = seq(0, RNA_log_cutoff, by = 0.1))  

h

ggsave("plots/CD8T_heatmap_pseudobulk_clustered_wardD2.pdf", plot=h, height=4, width=5)
ggsave("plots/CD8T_heatmap_pseudobulk_clustered_wardD2_big.pdf", plot=h, height=7, width=9)
...
genes <- c('SELL','LEF1',"S1PR1","IL7R", "TCF7", "CCR7","LMNA","GZMA","GZMK","CCL4",     "FGFBP2",'FCGR3A',"GNLY","KLRG1",'XCL1',"XCL2","CXCL13","CRTAM","TOX",'PDCD1',"HAVCR2","LAG3","CTLA4","ITGAE","CXCR6",
