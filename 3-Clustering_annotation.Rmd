...
h <- celltype.heatmap(integrated, cluster.col = 'functional.cluster',  metadata=c("SampleLabel", "Tissue"),
                  ...
                  min.cells=30, ref=integrated, cluster_genes = T, palette = mycols,
                  cluster_samples = TRUE, method="average", scale = "none",
...
h <- celltype.heatmap(integrated, cluster.col = 'functional.cluster',  metadata=c("SampleLabel", "Tissue"),
                  assay = "RNA_trimmed", palette = mycols,
                  genes = genes.use.bygroup.trimm, min.cells=30,
                  ref=integrated, cluster_genes = T, cluster_samples = TRUE,
                  method="ward.D2", scale = "none", brewer.palette = "Blues",
                  breaks = seq(0, RNA_log_cutoff, by = 0.1))  
